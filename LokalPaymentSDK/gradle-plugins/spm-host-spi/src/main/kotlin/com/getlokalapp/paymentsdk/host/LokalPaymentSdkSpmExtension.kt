...
/**
 * Backs the host's `lokalPaymentSdkSpm { }` DSL and is handed to every
 * [LokalGatewaySpmContributor]. The SPM-flavored sibling of
 ...
 */
open class LokalPaymentSdkSpmExtension {
