 ...
 * test compilation.
 *
 * Class name is module-prefixed on purpose: `:razorpay-checkout` and
 * `:razorpay-customui` share the package `com.getlokalapp.paymentsdk.razorpay`,
 * so identically named top-level files in both would collide — see
 * `docs/adding-a-new-gateway.md` §5 rule 9.
 *
 ...
 */
class RazorpayCheckoutHarnessSmokeTest {
