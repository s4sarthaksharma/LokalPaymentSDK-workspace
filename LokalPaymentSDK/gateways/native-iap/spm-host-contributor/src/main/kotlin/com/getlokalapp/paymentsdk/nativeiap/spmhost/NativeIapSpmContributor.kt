package com.getlokalapp.paymentsdk.nativeiap.spmhost
...
import com.getlokalapp.paymentsdk.host.SpmSourceTarget
import org.gradle.api.Project

/**
 * native-iap's build-time contribution to an iOS host under SPM. Unlike
 * `RazorpaySpmContributor` (which links a third-party vendor *package*), native-iap owns
 ...
 * `RazorpaySpmContributor`. This jar is always on the buildscript classpath (the umbrella
 ...
 */
class NativeIapSpmContributor : LokalGatewaySpmContributor {
