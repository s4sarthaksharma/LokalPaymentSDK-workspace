...
/**
 * AndroidX App Startup hook that registers [JuspayGatewayHandler] with zero host code:
 ...
 * make Juspay payable yet — the host's [JuspaySdk.configure] call is still
 * required.
 */
class JuspayInitializer : GatewayInitializer() {

    override fun create(context: Context): PaymentGatewayHandler = JuspayGatewayHandler
}
