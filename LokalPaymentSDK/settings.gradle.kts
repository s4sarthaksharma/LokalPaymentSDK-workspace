...
// The settings pair drives the settings phase (Maven repos, plugin pins); the host pair
// drives the iOS umbrella (Package.swift generation). CocoaPods scaffolding was removed in
// Phase 3 (see docs/cocoapods-to-spm-migration-plan.md).
include(":gradle-plugins:settings-spi")
include(":gradle-plugins:settings-plugin")
include(":gradle-plugins:host-spi")
include(":gradle-plugins:host-plugin")
include(":gradle-plugins:host-android-spi")
include(":gradle-plugins:host-android-plugin")
...
include(":gateways:native-iap:host-contributor")
include(":gateways:upi-intent")
include(":gateways:web-checkout")
include(":gateways:juspay")
include(":gateways:juspay:host-android-contributor")
